                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card mx-2">
                                        <div class="card-body">
                                            <h6 class="card-title d-flex justify-content-center">Рђgrobiznes</h6>
                        ...
                        <div class="swiper mySwiper ">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="card mx-2">
                                        <div class="card-body">
                                            <h6 class="card-title d-flex justify-content-center">Рђgrobiologiya</h6>
                        ...
                        <div class="swiper mySwiper ">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="card mx-2">
                                        <div class="card-body">
                                            <h6 class="card-title d-flex justify-content-center">Рђgroinjeneriya</h6>
